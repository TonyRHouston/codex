---
name: plan-prompt-76bf89
description: Use this skill when the user needs help with plan prompt. It provides
  practical guidance, execution steps, and quality checks for plan prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/plan.prompt.md as guidance.
