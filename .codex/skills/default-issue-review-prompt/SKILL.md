---
name: default-issue-review-prompt-180632
description: Use this skill when the user needs help with default issue review prompt.
  It provides practical guidance, execution steps, and quality checks for default
  issue review prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/default-issue-review.prompt.yml as guidance.
