---
name: breakdown-code-instructions-106d91
description: Use this skill when the user needs help with breakdown code instructions.
  It provides practical guidance, execution steps, and quality checks for breakdown
  code instructions tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/breakdown_code_instructions.prompt as guidance.
