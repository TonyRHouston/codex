---
name: problem-solver-iteration-prompt-ae100e
description: Use this skill when the user needs help with problem solver iteration
  prompt. It provides practical guidance, execution steps, and quality checks for
  problem solver iteration prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/problem-solver/iteration.prompt as guidance.
