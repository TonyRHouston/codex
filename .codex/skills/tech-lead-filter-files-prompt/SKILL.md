---
name: tech-lead-filter-files-prompt-a505b4
description: Use this skill when the user needs help with tech lead filter files prompt.
  It provides practical guidance, execution steps, and quality checks for tech lead
  filter files prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/tech-lead/filter_files.prompt as guidance.
