---
name: frontend-system-prompt-0941b1
description: Use this skill when the user needs help with frontend system prompt.
  It provides practical guidance, execution steps, and quality checks for frontend
  system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/frontend/system.prompt as guidance.
