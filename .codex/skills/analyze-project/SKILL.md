---
name: analyze-project-69f2ae
description: Use this skill when the user needs help with analyze project. It provides
  practical guidance, execution steps, and quality checks for analyze project tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/importer/analyze_project.prompt as guidance.
