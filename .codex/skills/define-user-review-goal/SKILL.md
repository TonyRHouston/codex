---
name: define-user-review-goal-e7652a
description: Use this skill when the user needs help with define user review goal.
  It provides practical guidance, execution steps, and quality checks for define user
  review goal tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/troubleshooter/define_user_review_goal.prompt as guidance.
