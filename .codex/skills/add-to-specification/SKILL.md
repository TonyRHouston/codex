---
name: add-to-specification-833834
description: Use this skill when the user needs help with add to specification. It
  provides practical guidance, execution steps, and quality checks for add to specification
  tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/spec-writer/add_to_specification.prompt as guidance.
