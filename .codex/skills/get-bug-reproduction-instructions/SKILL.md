---
name: get-bug-reproduction-instructions-2c583d
description: Use this skill when the user needs help with get bug reproduction instructions.
  It provides practical guidance, execution steps, and quality checks for get bug
  reproduction instructions tasks.
keywords:
- prompt
- get
- bug
...
- prompts
- bug-hunter
source: partially-processed/prompts/bug-hunter/get_bug_reproduction_instructions.prompt
allowed-tools: []
---

When to use
- Use when you need the prompt at partially-processed/prompts/bug-hunter/get_bug_reproduction_instructions.prompt as guidance.
