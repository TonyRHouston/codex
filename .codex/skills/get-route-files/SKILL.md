---
name: get-route-files-11f0e1
description: Use this skill when the user needs help with get route files. It provides
  practical guidance, execution steps, and quality checks for get route files tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/troubleshooter/get_route_files.prompt as guidance.
