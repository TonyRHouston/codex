---
name: prompt-complexity-b0be35
description: Use this skill when the user needs help with prompt complexity. It provides
  practical guidance, execution steps, and quality checks for prompt complexity tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/spec-writer/prompt_complexity.prompt as guidance.
