---
name: coding-rules-cb3323
description: Use this skill when the user needs help with coding rules. It provides
  practical guidance, execution steps, and quality checks for coding rules tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/coding_rules.prompt as guidance.
