---
name: plan-05516c
description: Use this skill when the user needs help with plan. It provides practical
  guidance, execution steps, and quality checks for plan tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/tech-lead/plan.prompt as guidance.
