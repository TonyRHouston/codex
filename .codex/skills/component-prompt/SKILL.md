---
name: component-prompt-cf0e58
description: Use this skill when the user needs help with component prompt. It provides
  practical guidance, execution steps, and quality checks for component prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/component.prompt.md as guidance.
