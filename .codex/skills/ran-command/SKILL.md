---
name: ran-command-66c94c
description: Use this skill when the user needs help with ran command. It provides
  practical guidance, execution steps, and quality checks for ran command tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/executor/ran_command.prompt as guidance.
