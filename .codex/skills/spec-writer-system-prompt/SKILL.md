---
name: spec-writer-system-prompt-04492e
description: Use this skill when the user needs help with spec writer system prompt.
  It provides practical guidance, execution steps, and quality checks for spec writer
  system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/spec-writer/system.prompt as guidance.
