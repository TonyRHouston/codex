---
name: codenotify-prompt-191ba2
description: Use this skill when the user needs help with codenotify prompt. It provides
  practical guidance, execution steps, and quality checks for codenotify prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/codenotify.prompt.md as guidance.
