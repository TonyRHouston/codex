---
name: review-spec-ca89a1
description: Use this skill when the user needs help with review spec. It provides
  practical guidance, execution steps, and quality checks for review spec tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/spec-writer/review_spec.prompt as guidance.
