---
name: create-rag-query-506156
description: Use this skill when the user needs help with create rag query. It provides
  practical guidance, execution steps, and quality checks for create rag query tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/frontend/create_rag_query.prompt as guidance.
