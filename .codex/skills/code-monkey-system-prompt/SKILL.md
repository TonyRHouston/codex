---
name: code-monkey-system-prompt-b70b57
description: Use this skill when the user needs help with code monkey system prompt.
  It provides practical guidance, execution steps, and quality checks for code monkey
  system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/code-monkey/system.prompt as guidance.
