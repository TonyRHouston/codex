---
name: iteration-13c503
description: Use this skill when the user needs help with iteration. It provides practical
  guidance, execution steps, and quality checks for iteration tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/troubleshooter/iteration.prompt as guidance.
