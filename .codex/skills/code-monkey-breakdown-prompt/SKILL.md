---
name: code-monkey-breakdown-prompt-8b7ad4
description: Use this skill when the user needs help with code monkey breakdown prompt.
  It provides practical guidance, execution steps, and quality checks for code monkey
  breakdown prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/code-monkey/breakdown.prompt as guidance.
