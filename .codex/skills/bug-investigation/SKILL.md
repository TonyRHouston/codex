---
name: bug-investigation-871246
description: Use this skill when the user needs help with bug investigation. It provides
  practical guidance, execution steps, and quality checks for bug investigation tasks.
license: MIT
---
