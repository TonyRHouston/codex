---
name: file-size-limit-258fc2
description: Use this skill when the user needs help with file size limit. It provides
  practical guidance, execution steps, and quality checks for file size limit tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/file_size_limit.prompt as guidance.
