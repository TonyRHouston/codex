---
name: developer-system-prompt-b905be
description: Use this skill when the user needs help with developer system prompt.
  It provides practical guidance, execution steps, and quality checks for developer
  system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/developer/system.prompt as guidance.
