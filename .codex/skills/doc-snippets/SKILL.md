---
name: doc-snippets-363a27
description: Use this skill when the user needs help with doc snippets. It provides
  practical guidance, execution steps, and quality checks for doc snippets tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/doc_snippets.prompt as guidance.
