---
name: need-auth-57e28f
description: Use this skill when the user needs help with need auth. It provides practical
  guidance, execution steps, and quality checks for need auth tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/spec-writer/need_auth.prompt as guidance.
