---
name: plan-deep-prompt-8bb9bc
description: Use this skill when the user needs help with plan deep prompt. It provides
  practical guidance, execution steps, and quality checks for plan deep prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/plan-deep.prompt.md as guidance.
