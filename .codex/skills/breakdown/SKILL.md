---
name: breakdown-c6656c
description: Use this skill when the user needs help with breakdown. It provides practical
  guidance, execution steps, and quality checks for breakdown tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/troubleshooter/breakdown.prompt as guidance.
