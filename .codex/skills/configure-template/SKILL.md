---
name: configure-template-f740d5
description: Use this skill when the user needs help with configure template. It provides
  practical guidance, execution steps, and quality checks for configure template tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/architect/configure_template.prompt as guidance.
