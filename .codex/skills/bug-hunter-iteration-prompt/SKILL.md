---
name: bug-hunter-iteration-prompt-900df7
description: Use this skill when the user needs help with bug hunter iteration prompt.
  It provides practical guidance, execution steps, and quality checks for bug hunter
  iteration prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/bug-hunter/iteration.prompt as guidance.
