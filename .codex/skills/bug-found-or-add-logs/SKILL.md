---
name: bug-found-or-add-logs-ab13ec
description: Use this skill when the user needs help with bug found or add logs. It
  provides practical guidance, execution steps, and quality checks for bug found or
  add logs tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/bug-hunter/bug_found_or_add_logs.prompt as guidance.
