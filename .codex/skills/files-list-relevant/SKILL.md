---
name: files-list-relevant-5f16d2
description: Use this skill when the user needs help with files list relevant. It
  provides practical guidance, execution steps, and quality checks for files list
  relevant tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/files_list_relevant.prompt as guidance.
