---
name: architect-system-prompt-ecb4ac
description: Use this skill when the user needs help with architect system prompt.
  It provides practical guidance, execution steps, and quality checks for architect
  system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/architect/system.prompt as guidance.
