---
name: issue-resolution-ce8386
description: Use this skill when the user needs help with issue resolution. It provides
  practical guidance, execution steps, and quality checks for issue resolution tasks.
keywords:
- fix
- issue
- github-issue
...
## When to use
- Use when the user request explicitly maps to **issue resolution** outcomes.
