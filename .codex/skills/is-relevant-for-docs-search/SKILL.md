---
name: is-relevant-for-docs-search-2a902f
description: Use this skill when the user needs help with is relevant for docs search.
  It provides practical guidance, execution steps, and quality checks for is relevant
  for docs search tasks.
keywords:
- prompt
- is
- relevant
...
- prompts
- frontend
source: partially-processed/prompts/frontend/is_relevant_for_docs_search.prompt
allowed-tools: []
---

When to use
- Use when you need the prompt at partially-processed/prompts/frontend/is_relevant_for_docs_search.prompt as guidance.
