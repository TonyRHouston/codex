---
name: get-run-command-725cb2
description: Use this skill when the user needs help with get run command. It provides
  practical guidance, execution steps, and quality checks for get run command tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/troubleshooter/get_run_command.prompt as guidance.
