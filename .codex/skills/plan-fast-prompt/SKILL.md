---
name: plan-fast-prompt-296f85
description: Use this skill when the user needs help with plan fast prompt. It provides
  practical guidance, execution steps, and quality checks for plan fast prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/plan-fast.prompt.md as guidance.
