---
name: data-about-logs-936695
description: Use this skill when the user needs help with data about logs. It provides
  practical guidance, execution steps, and quality checks for data about logs tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/bug-hunter/data_about_logs.prompt as guidance.
