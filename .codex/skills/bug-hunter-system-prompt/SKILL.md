---
name: bug-hunter-system-prompt-ebca16
description: Use this skill when the user needs help with bug hunter system prompt.
  It provides practical guidance, execution steps, and quality checks for bug hunter
  system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/bug-hunter/system.prompt as guidance.
