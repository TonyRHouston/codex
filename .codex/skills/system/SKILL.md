---
name: system-b5513b
description: Use this skill when the user needs help with system. It provides practical
  guidance, execution steps, and quality checks for system tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/troubleshooter/system.prompt as guidance.
