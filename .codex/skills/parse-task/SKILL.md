---
name: parse-task-523cca
description: Use this skill when the user needs help with parse task. It provides
  practical guidance, execution steps, and quality checks for parse task tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/developer/parse_task.prompt as guidance.
