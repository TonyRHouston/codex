---
name: ask-a-question-827b86
description: Use this skill when the user needs help with ask a question. It provides
  practical guidance, execution steps, and quality checks for ask a question tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/bug-hunter/ask_a_question.prompt as guidance.
