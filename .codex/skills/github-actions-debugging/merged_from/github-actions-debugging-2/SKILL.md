---
name: github-actions-debugging-2
description: Debug failing GitHub Actions workflows efficiently. Use this when asked to investigate CI failures, workflow issues, or GitHub Actions problems.
license: MIT
source: skills/skills/github-actions-debugging/SKILL.md
---
