---
name: problem-solver-system-prompt-86637d
description: Use this skill when the user needs help with problem solver system prompt.
  It provides practical guidance, execution steps, and quality checks for problem
  solver system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/problem-solver/system.prompt as guidance.
