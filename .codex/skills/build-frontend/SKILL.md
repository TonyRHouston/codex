---
name: build-frontend-e5a69d
description: Use this skill when the user needs help with build frontend. It provides
  practical guidance, execution steps, and quality checks for build frontend tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/frontend/build_frontend.prompt as guidance.
