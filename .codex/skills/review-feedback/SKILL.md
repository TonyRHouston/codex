---
name: review-feedback-3f50a0
description: Use this skill when the user needs help with review feedback. It provides
  practical guidance, execution steps, and quality checks for review feedback tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/code-monkey/review_feedback.prompt as guidance.
