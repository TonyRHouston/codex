---
name: project-tasks-19c1dd
description: Use this skill when the user needs help with project tasks. It provides
  practical guidance, execution steps, and quality checks for project tasks tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/project_tasks.prompt as guidance.
