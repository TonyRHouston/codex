---
name: debug-f290c0
description: Use this skill when the user needs help with debug. It provides practical
  guidance, execution steps, and quality checks for debug tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/error-handler/debug.prompt as guidance.
