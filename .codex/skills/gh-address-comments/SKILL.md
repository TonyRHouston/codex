---
name: gh-address-comments-a9cb77
description: Use this skill when the user needs help with gh address comments. It
  provides practical guidance, execution steps, and quality checks for gh address
  comments tasks.
metadata:
...
## When to use
- Use when the user request explicitly maps to **gh address comments** outcomes.
