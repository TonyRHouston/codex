---
name: tech-writer-system-prompt-d245d8
description: Use this skill when the user needs help with tech writer system prompt.
  It provides practical guidance, execution steps, and quality checks for tech writer
  system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/tech-writer/system.prompt as guidance.
