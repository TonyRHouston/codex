---
name: commit-40d441
description: Use this skill when the user needs help with commit. It provides practical
  guidance, execution steps, and quality checks for commit tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/pythagora/commit.prompt as guidance.
