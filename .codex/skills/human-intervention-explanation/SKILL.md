---
name: human-intervention-explanation-0a1347
description: Use this skill when the user needs help with human intervention explanation.
  It provides practical guidance, execution steps, and quality checks for human intervention
  explanation tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/human_intervention_explanation.prompt as guidance.
