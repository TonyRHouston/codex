---
name: bug-report-review-prompt-2423d6
description: Use this skill when the user needs help with bug report review prompt.
  It provides practical guidance, execution steps, and quality checks for bug report
  review prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/bug-report-review.prompt.yml as guidance.
