---
name: build-champ-prompt-62b925
description: Use this skill when the user needs help with build champ prompt. It provides
  practical guidance, execution steps, and quality checks for build champ prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/build-champ.prompt.md as guidance.
