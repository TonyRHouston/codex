---
name: skills-tui-exit-shutdown-skill-5a8e67
description: 'Guide exit, shutdown, and interrupt flows for the Copilot TUI. Use when
  ...
  '
source: skills/tui-exit-shutdown/SKILL.md
---

# skills-tui-exit-shutdown-skill

## When to use
- Use when the user request explicitly maps to **skills tui exit shutdown skill** outcomes.
