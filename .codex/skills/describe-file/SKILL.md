---
name: describe-file-bcdcd1
description: Use this skill when the user needs help with describe file. It provides
  practical guidance, execution steps, and quality checks for describe file tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/code-monkey/describe_file.prompt as guidance.
