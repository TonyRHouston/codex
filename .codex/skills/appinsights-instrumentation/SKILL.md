---
name: appinsights-instrumentation-3e9336
description: Use this skill when the user needs help with appinsights instrumentation.
  It provides practical guidance, execution steps, and quality checks for appinsights
