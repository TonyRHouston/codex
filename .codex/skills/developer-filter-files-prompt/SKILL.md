---
name: developer-filter-files-prompt-d9a062
description: Use this skill when the user needs help with developer filter files prompt.
  It provides practical guidance, execution steps, and quality checks for developer
  filter files prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/developer/filter_files.prompt as guidance.
