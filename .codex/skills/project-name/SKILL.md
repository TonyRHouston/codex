---
name: project-name-5a618d
description: Use this skill when the user needs help with project name. It provides
  practical guidance, execution steps, and quality checks for project name tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/spec-writer/project_name.prompt as guidance.
