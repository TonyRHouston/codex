---
name: skills-code-review-structured-skill-fb0bd8
description: Use this skill when the user needs help with skills code review structured
  skill. It provides practical guidance, execution steps, and quality checks for skills
  code review structured skill tasks.
license: MIT
source: skills/code-review-structured/SKILL.md
---
