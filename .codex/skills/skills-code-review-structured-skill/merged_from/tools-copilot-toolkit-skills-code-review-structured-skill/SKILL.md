---
name: tools-copilot-toolkit-skills-code-review-structured-skill
description: Perform comprehensive code reviews using structured templates and validation
  tools. Use this when asked to review code or analyze pull requests.
license: MIT
source: tools/copilot-toolkit/skills/code-review-structured/SKILL.md
---
