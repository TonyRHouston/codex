---
name: tools-copilot-toolkit-skills-bug-investigation-skill
description: Systematic approach to investigating and fixing bugs using structured
  methodology. Use this when asked to debug issues, investigate failures, or fix bugs.
license: MIT
source: tools/copilot-toolkit/skills/bug-investigation/SKILL.md
---
