---
name: files-descriptions-1837eb
description: Use this skill when the user needs help with files descriptions. It provides
  practical guidance, execution steps, and quality checks for files descriptions tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/files_descriptions.prompt as guidance.
