---
name: problem-explanation-cf792f
description: Use this skill when the user needs help with problem explanation. It
  provides practical guidance, execution steps, and quality checks for problem explanation
  tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/bug-hunter/problem_explanation.prompt as guidance.
