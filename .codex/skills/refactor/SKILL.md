---
name: refactor-957c48
description: Use this skill when the user needs help with refactor. It provides practical
  guidance, execution steps, and quality checks for refactor tasks.
license: MIT
---
