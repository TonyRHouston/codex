---
name: file-naming-f75897
description: Use this skill when the user needs help with file naming. It provides
  practical guidance, execution steps, and quality checks for file naming tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/file_naming.prompt as guidance.
