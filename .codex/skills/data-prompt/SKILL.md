---
name: data-prompt-db4658
description: Use this skill when the user needs help with data prompt. It provides
  practical guidance, execution steps, and quality checks for data prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/data.prompt.md as guidance.
