---
name: log-extraction-688068
description: Use this skill when the user needs help with log extraction. It provides
  practical guidance, execution steps, and quality checks for log extraction tasks.
license: MIT
...
## When to use
- Use when the user request explicitly maps to **log extraction** outcomes.
