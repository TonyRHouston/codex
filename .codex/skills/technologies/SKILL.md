---
name: technologies-80d65d
description: Use this skill when the user needs help with technologies. It provides
  practical guidance, execution steps, and quality checks for technologies tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/architect/technologies.prompt as guidance.
