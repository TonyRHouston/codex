---
name: developer-breakdown-prompt-9a3ba1
description: Use this skill when the user needs help with developer breakdown prompt.
  It provides practical guidance, execution steps, and quality checks for developer
  breakdown prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/developer/breakdown.prompt as guidance.
