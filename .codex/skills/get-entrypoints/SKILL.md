---
name: get-entrypoints-deb9de
description: Use this skill when the user needs help with get entrypoints. It provides
  practical guidance, execution steps, and quality checks for get entrypoints tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/importer/get_entrypoints.prompt as guidance.
