---
name: update-instructions-prompt-fb8f88
description: Use this skill when the user needs help with update instructions prompt.
  It provides practical guidance, execution steps, and quality checks for update instructions
  prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/update-instructions.prompt.md as guidance.
