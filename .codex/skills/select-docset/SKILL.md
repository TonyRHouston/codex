---
name: select-docset-26ca0b
description: Use this skill when the user needs help with select docset. It provides
  practical guidance, execution steps, and quality checks for select docset tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/external-docs/select_docset.prompt as guidance.
