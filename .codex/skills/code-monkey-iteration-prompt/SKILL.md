---
name: code-monkey-iteration-prompt-a0d7fc
description: Use this skill when the user needs help with code monkey iteration prompt.
  It provides practical guidance, execution steps, and quality checks for code monkey
  iteration prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/code-monkey/iteration.prompt as guidance.
