---
name: vibe-coding-4e2476
description: Use this skill when the user needs help with vibe coding. It provides
  practical guidance, execution steps, and quality checks for vibe coding tasks.
---
