---
name: relative-paths-cfdc16
description: Use this skill when the user needs help with relative paths. It provides
  practical guidance, execution steps, and quality checks for relative paths tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/relative_paths.prompt as guidance.
