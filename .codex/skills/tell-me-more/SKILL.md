---
name: tell-me-more-d84e1e
description: Use this skill when the user needs help with tell me more. It provides
  practical guidance, execution steps, and quality checks for tell me more tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/bug-hunter/tell_me_more.prompt as guidance.
