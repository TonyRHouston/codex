---
name: project-details-12b1e7
description: Use this skill when the user needs help with project details. It provides
  practical guidance, execution steps, and quality checks for project details tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/project_details.prompt as guidance.
