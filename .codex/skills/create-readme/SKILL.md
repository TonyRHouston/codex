---
name: create-readme-d67595
description: Use this skill when the user needs help with create readme. It provides
  practical guidance, execution steps, and quality checks for create readme tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/tech-writer/create_readme.prompt as guidance.
