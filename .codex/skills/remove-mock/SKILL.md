---
name: remove-mock-5edfa8
description: Use this skill when the user needs help with remove mock. It provides
  practical guidance, execution steps, and quality checks for remove mock tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/frontend/remove_mock.prompt as guidance.
