---
name: get-alternative-solutions-102915
description: Use this skill when the user needs help with get alternative solutions.
  It provides practical guidance, execution steps, and quality checks for get alternative
  solutions tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/problem-solver/get_alternative_solutions.prompt as guidance.
