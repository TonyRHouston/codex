---
name: create-docs-queries-d65659
description: Use this skill when the user needs help with create docs queries. It
  provides practical guidance, execution steps, and quality checks for create docs
  queries tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/external-docs/create_docs_queries.prompt as guidance.
