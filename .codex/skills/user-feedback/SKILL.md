---
name: user-feedback-140747
description: Use this skill when the user needs help with user feedback. It provides
  practical guidance, execution steps, and quality checks for user feedback tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/user_feedback.prompt as guidance.
