---
name: epic-breakdown-523935
description: Use this skill when the user needs help with epic breakdown. It provides
  practical guidance, execution steps, and quality checks for epic breakdown tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/tech-lead/epic_breakdown.prompt as guidance.
