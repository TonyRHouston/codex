---
name: build-full-specification-b41a14
description: Use this skill when the user needs help with build full specification.
  It provides practical guidance, execution steps, and quality checks for build full
  specification tasks.
keywords:
- prompt
- build
...
- prompts
- spec-writer
source: partially-processed/prompts/spec-writer/build_full_specification.prompt
allowed-tools: []
---

When to use
- Use when you need the prompt at partially-processed/prompts/spec-writer/build_full_specification.prompt as guidance.
