---
name: skills-skills-json-validation-skill
description: Validate and work with JSON configuration files. Use this when asked
  to validate JSON, check configuration files, or work with JSON data.
license: MIT
source: skills/skills/json-validation/SKILL.md
---
