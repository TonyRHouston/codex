---
name: filter-files-da3e4f
description: Use this skill when the user needs help with filter files. It provides
  practical guidance, execution steps, and quality checks for filter files tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/troubleshooter/filter_files.prompt as guidance.
