---
name: chat-f6143a
description: Use this skill when the user needs help with chat. It provides practical
  guidance, execution steps, and quality checks for chat tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/chat-agent/chat.prompt as guidance.
