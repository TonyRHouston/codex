---
name: setup-environment-prompt-6aeb4b
description: Use this skill when the user needs help with setup environment prompt.
  It provides practical guidance, execution steps, and quality checks for setup environment
  prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/setup-environment.prompt.md as guidance.
