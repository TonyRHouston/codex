---
name: log-data-a9a3f5
description: Use this skill when the user needs help with log data. It provides practical
  guidance, execution steps, and quality checks for log data tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/bug-hunter/log_data.prompt as guidance.
