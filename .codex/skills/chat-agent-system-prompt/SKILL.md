---
name: chat-agent-system-prompt-02ec56
description: Use this skill when the user needs help with chat agent system prompt.
  It provides practical guidance, execution steps, and quality checks for chat agent
  system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/chat-agent/system.prompt as guidance.
