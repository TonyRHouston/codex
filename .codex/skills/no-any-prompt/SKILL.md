---
name: no-any-prompt-b32f34
description: Use this skill when the user needs help with no any prompt. It provides
  practical guidance, execution steps, and quality checks for no any prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/no-any.prompt.md as guidance.
