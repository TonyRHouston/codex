---
name: files-list-56e5d6
description: Use this skill when the user needs help with files list. It provides
  practical guidance, execution steps, and quality checks for files list tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/partials/files_list.prompt as guidance.
