---
name: add-new-feature-2d9f08
description: Use this skill when the user needs help with add new feature. It provides
  practical guidance, execution steps, and quality checks for add new feature tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/spec-writer/add_new_feature.prompt as guidance.
