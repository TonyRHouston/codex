---
name: skills-vibe-coding-skill-72d25e
description: Use this skill when the user needs help with skills vibe coding skill.
  It provides practical guidance, execution steps, and quality checks for skills vibe
  coding skill tasks.
source: skills/vibe-coding/SKILL.md
---
