---
name: external-docs-system-prompt-9209bb
description: Use this skill when the user needs help with external docs system prompt.
  It provides practical guidance, execution steps, and quality checks for external
  docs system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/external-docs/system.prompt as guidance.
