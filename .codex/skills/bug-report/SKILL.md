---
name: bug-report-04f934
description: Use this skill when the user needs help with bug report. It provides
  practical guidance, execution steps, and quality checks for bug report tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/troubleshooter/bug_report.prompt as guidance.
