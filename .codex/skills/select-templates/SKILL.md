---
name: select-templates-9cf6e0
description: Use this skill when the user needs help with select templates. It provides
  practical guidance, execution steps, and quality checks for select templates tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/architect/select_templates.prompt as guidance.
