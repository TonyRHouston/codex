---
name: review-changes-a9019c
description: Use this skill when the user needs help with review changes. It provides
  practical guidance, execution steps, and quality checks for review changes tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/code-monkey/review_changes.prompt as guidance.
