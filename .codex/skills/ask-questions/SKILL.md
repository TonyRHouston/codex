---
name: ask-questions-52b8b4
description: Use this skill when the user needs help with ask questions. It provides
  practical guidance, execution steps, and quality checks for ask questions tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/spec-writer/ask_questions.prompt as guidance.
