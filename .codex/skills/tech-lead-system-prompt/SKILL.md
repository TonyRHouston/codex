---
name: tech-lead-system-prompt-e16543
description: Use this skill when the user needs help with tech lead system prompt.
  It provides practical guidance, execution steps, and quality checks for tech lead
  system prompt tasks.
---

When to use
- Use when you need the prompt at partially-processed/prompts/tech-lead/system.prompt as guidance.
